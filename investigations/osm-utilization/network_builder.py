...
PLACE_NAME = "Belfast, Northern Ireland, United Kingdom"
NETWORK_TYPE = "drive"  # Options: 'drive', 'walk', 'bike', 'all'
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), "belfast_network.xml")
CRS_EPSG = "EPSG:2157"  # Irish Transverse Mercator projection (covers all of Ireland incl. NI)
...
def networkx_to_matsim(G, output_file):
    ...
    root = ET.Element("network", name="belfast-network")
